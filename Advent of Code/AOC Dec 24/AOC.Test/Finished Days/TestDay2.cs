...
public class TestDay2 {
    ...
    [InlineData(1, 3, 8, false)]
    [InlineData(1, 3, 3, false)]
    public void Test1(int int1, int int2, int int3, bool expected) {
        Program.ValidateSafety(new int[] { int1, int2, int3 }).Should().Be(expected);
    }

    [Fact]
    public void Answer1() {
        Program.CountSafeValues(vals, false).Should().Be(591);
    }
    ...
    public void Test2(int[] values, bool expected) {
        Program.ValidateSafetyWith1Removal(values).Should().Be(expected);
    }

    [Fact]
    public void Answer2() {
        Program.CountSafeValues(vals, true).Should().Be(621);
    }
}
